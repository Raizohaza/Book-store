...
namespace DoAn1
{
    ...
    public sealed partial class PageAdmin : Page
    {
        ...
        private void Done_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            ColumChartScrollView.Visibility = Visibility.Collapsed;
            LineChartScrollView.Visibility = Visibility.Collapsed;
        ...
        private void LineChartButton_Click(object sender, RoutedEventArgs e)
        {
            PieChartScrollView.Visibility = Visibility.Collapsed;
            ColumChartScrollView.Visibility = Visibility.Collapsed;
            LineChartScrollView.Visibility = Visibility.Visible;
            DataGridProduct.Visibility = Visibility.Collapsed;
